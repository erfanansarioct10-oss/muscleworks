    ...
    >
      <div className="flex items-center gap-2 min-w-max px-0.5">
        ...
        <button
          ...
          className={cn(
            'inline-flex items-center justify-center rounded-full px-4 py-2 text-xs sm:text-sm font-medium tracking-wide transition-all min-h-11 touch-manipulation focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold-500',
            isAllActive
              ? 'bg-neutral-900 text-white shadow-sm ring-1 ring-gold-500/50'
