...
export function HeroSection() {
  ...
  return (
    <section className="relative w-full min-h-[calc(100dvh-4rem)] sm:min-h-[calc(100dvh-5rem)] overflow-hidden bg-background flex items-center justify-center">
      ...
      <div className="absolute inset-0 z-0 md:hidden select-none pointer-events-none" aria-hidden="true">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-black/80 via-black/50 to-black/70 pointer-events-none select-none" />
      </div>
      ...
      <div className="relative z-10 mx-auto flex h-full w-full max-w-7xl items-center justify-start px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16">
        <div className="w-full max-w-xl md:max-w-4xl lg:max-w-5xl space-y-5 sm:space-y-7 flex flex-col items-start text-left">
          ...
          <h1 className="font-heading font-black tracking-tight uppercase italic leading-[0.95] text-left max-w-full">
            ...
            <span className="block whitespace-nowrap text-3xl sm:text-5xl md:text-5xl lg:text-6xl xl:text-7xl text-amber-400 mt-1 sm:mt-2">
              BEST EVERYDAY
            </span>
          </h1>
              ...
              return (
                <div key={idx} className="flex items-center justify-start gap-2.5 sm:gap-3">
                  ...
                  <div className="flex flex-col text-left min-w-0">
                    <span className="text-[11px] sm:text-xs font-extrabold uppercase tracking-wider text-amber-400 truncate">
                      {badge.title}
                    </span>
