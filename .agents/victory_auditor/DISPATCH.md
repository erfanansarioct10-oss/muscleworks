...
Your working directory for metadata: c:/nooridigital_assets/my-projects/muscleworks/.agents/victory_auditor
Perform an independent, post-victory audit of all claims, run independent test executions, check for cheating or fake passes, and report a structured confirmed/rejected verdict.
